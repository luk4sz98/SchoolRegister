...
public static class Extensions
{
    ...
    public static async void SeedData(this IServiceCollection services)
    {
        ...
        await dbContext.Group.AddAsync(groupIo);
        ...
        await dbContext.Group.AddAsync(groupPai);
        ...
        await dbContext.Group.AddAsync(groupAipErasmus);

        //All users, including teacher, students and parents
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup1);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup2);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup3);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup4);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup5);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup6);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup7);
        ...
        await dbContext.SubjectGroup.AddAsync(subjectGroup8);
